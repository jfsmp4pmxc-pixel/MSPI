...
### Melon Sandbox Plug In
 Đây là một chương trình cho phép bạn cài đặt phần mở rộng (tệp .deb/.dylib) vào Melon Sandbox và nhiều hơn thế.

### không dùng với mục đích gian lận!
 Nếu bạn đến đây để tìm một chương trình để gian lận thì xin mời bạn ra chỗ khác.

### mạng xã hội
@B40Ph4m | https://www.youtube.com/@B40Ph4m
...
### hướng dẫn thiết lập
 Do **giới hạn hệ thống** và sự kiểm duyệt **khắc khe của Apple**, tôi không thể phát hành ứng dụng lên AppStore. Nên để sử dụng bản Demo hoặc Full thì có những hướng dẫn sau đây:
 1. với bản Demo (skip đến bước 4 nếu bạn đã tải công cụ sideload ipa):  
