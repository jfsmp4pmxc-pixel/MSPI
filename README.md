...
### hướng dẫn thiết lập
 ...
 1. với bản Demo (skip đến bước 4 nếu bạn đã tải):  
   ...
   5, bạn quay lại đây và tìm mục "releases" ở repo này và tìm bản build mà bạn muốn để tải **(lưu ý là tải cái có đuôi là .ipa, vd: MSPIv1.0(36).ipa)**  
### Nhật ký thay đổi
b0.1 (1):
